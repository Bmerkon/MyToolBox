# -*- coding: utf-8 -*-
"""
Created on Fri Dec 15 11:02:27 2017
...
#from basicfunctions import my_save,my_load
from BmerkonToolBox.SimpleTools.basicfunctions import my_save,my_load
#%%
def my_load_f(name):
...
def factordaily(factor_list,factor_params,customfactor,last_day,init=False,new_start_str=None):
    ...
    for fname in factor_list:
        ...
        if old_fv.empty:# 为空，则从tradingday的第一天开始算起
            ...
            if old_last_day<tradingday.iloc[-1]:
                #pdb.set_trace()
