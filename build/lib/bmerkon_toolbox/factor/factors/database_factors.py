...
#from bmerkon_toolbox.DataImport.JuyuanQuery import JuYuanDB
...
#%% factors 
class TradingDate(CustomFactor):
...
class StockDailyPrice(CustomFactor):
...
class RestoreFactor(CustomFactor):
...
class IndustryFactor(CustomFactor):
...
class CapitalFactor(CustomFactor):
    def __init__(self,name,first_day='2010-01-01',last_day='2010-01-01'):
        self.params['name']=name
        self.params['first_day']=first_day
        self.params['last_day']=last_day
...
class MarketValue(CustomFactor):
    def __init__(self):
        pass
...
class DaluTongHolding(CustomFactor):
